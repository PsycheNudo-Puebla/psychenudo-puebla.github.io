(window.levelLogics = window.levelLogics || {})['tennis'] = {
    ...
    init: function(levelData) {
        ...
        this.diablo = { x: 400 - 40, y: 120, w: 80, h: 15, speed: 7 }; // Personaje del Diablo
    ...
    update: function() {
        ...
        if (this.countdownActive) {
            ...
            if (this.countdownTimer <= 0) {
                ...
                if (this.countdownValue <= 0) {
                    this.countdownActive = false;
                    this.bomb.vx = 6.5 * (Math.random() > 0.5 ? 1 : -1);
                    this.bomb.vy = 6.5 * (Math.random() > 0.5 ? 1 : -1);
                }
            }
        ...
        // IA del Diablo (horizontal)
        let targetX = this.bomb.x - this.diablo.w / 2;
        ...
        if (this.bomb.vy < 0 && // Bomba moviéndose hacia arriba
            ...
            let hit = (this.bomb.x - (this.diabloPaddle.x + this.diabloPaddle.w / 2)) / (this.diabloPaddle.w / 2);
            this.bomb.vx = hit * 7;
